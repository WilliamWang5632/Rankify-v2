      ...
      <Card className="bg-gray-800 border-gray-700 sticky top-6">
        <CardContent className="p-4">
          ...
          <div className="space-y-2">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                Rating: <span className="text-indigo-400 font-bold">{form.rating || 0}/10</span>
              </label>
              <div className="space-y-2">
                <input
                  type="range"
                  ...
                  style={{
                    background: `linear-gradient(to right, #6366f1 0%, #6366f1 ${(form.rating / 10) * 100}%, #374151 ${(form.rating / 10) * 100}%, #374151 100%)`
                  }}
                />
              </div>
            </div>
